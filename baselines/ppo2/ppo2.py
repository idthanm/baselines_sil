...
def learn(*, network, env, total_timesteps, eval_env=None, seed=None, nsteps=2048, ent_coef=0.0, lr=3e-4,
          ...
          save_interval=100, load_path=None, model_fn=None, update_fn=None, init_fn=None, mpi_rank_weight=1,
          render=False, comm=None, **network_kwargs):
    '''
    ...
    **network_kwargs:                 keyword arguments to the policy / network builder. See baselines.common/policies.py/build_policy and arguments to a particular type of network
    ...
    if load_path is not None:
        ...
        tf.train.Saver().restore(model.sess, load_path)
    ...
    for update in range(1, nupdates + 1):
        ...
        if save_interval and (update % save_interval == 0 or update == 1) and logger.get_dir() and is_mpi_root:
            ...
            tf.train.Saver().save(sess=model.sess, save_path=savepath, write_meta_graph=True)
            # model.save(savepath)
